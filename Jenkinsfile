pipeline { 
    ...
    environment { 
        ...
        DOCKER_IMAGE = 'gin5567/teedy2025' // your Docker Hub user name and Repository's name 
        ...
        stage('Build') { 
            steps { 
                checkout scmGit( 
                    ...
                    extensions: [],  
                    userRemoteConfigs: [[url: 'https://github.com/Gin5567/Teedy.git']] // your github Repository
                ) 
